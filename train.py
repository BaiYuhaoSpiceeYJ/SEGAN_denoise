    ...
    if opts.clean_valset is not None:
        if opts.h5:
            ...
            va_dset = SEDataset(opts.clean_valset, 
                                ...
                                slice_workers=opts.slice_workers,
                                preemph_norm=opts.preemph_norm)
        va_dloader = DataLoader(va_dset, batch_size=32,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--d_pretrained_ckpt', type=str, default='ckpt_segan+\weights_EOE_D-Discriminator-97616.ckpt',
                        help='Path to ckpt file to pre-load in training '
                             '(Def: None).')
    parser.add_argument('--g_pretrained_ckpt', type=str, default='ckpt_segan+\weights_EOE_G-Generator-97616.ckpt',
                        help='Path to ckpt file to pre-load in training '
                             '(Def: None).')
    ...
    parser.add_argument('--dpool_slen', type=int, default=4,
